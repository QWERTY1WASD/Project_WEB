...
def main():
    ...
    application.add_handler(CommandHandler("poem", print_random_poem))
    application.add_handler(CommandHandler("place", get_random_place))
    application.add_handler(CommandHandler("bot", info_bot))
