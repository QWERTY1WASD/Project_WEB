...
RANDOM_CASE_WORDS = ['случайная задача', 'задача', 'рандомная задача', 'case', 'random case']
RANDOM_PLACE_WORDS = ['случайное место', 'место', 'рандомное место', 'place', 'random place']
RANDOM_POEM_WORDS = ['случайный стих', 'стих', 'рандомный стих', 'стихотворение', 'поэма', 'poem', 'random poem']
